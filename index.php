...
class OneFileLoginApplication
{
     ...
     */
    private $db_sqlite_path = "tmpdir/students.db";
    ...
    private function createNewUser()
    {
        ...
        $sql = 'SELECT * FROM graders WHERE userName = :user_name OR email = :user_email';
        $query = $this->db_connection->prepare($sql);
        ...
        if ($result_row) {
            ...
            $sql = 'INSERT INTO graders (userName, password, email)
